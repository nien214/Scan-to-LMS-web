...
- The latest uploaded database is uploaded to Supabase Storage and becomes the shared lookup source for all devices.
...
- Apply the processed-database storage migration before using the shared upload flow.
